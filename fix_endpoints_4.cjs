...
code = code.replace(/const renderBackendUrl = 'https:\/\/tracexdata-api.onrender.com';/g, "");
code = code.replace(/const renderBackendUrl = import.meta.env.VITE_RENDER_BACKEND_URL \|\| 'https:\/\/tracexdata-api.onrender.com';/g, "");
code = code.replace(/const renderBackendUrl = import\.meta\.env\.VITE_RENDER_BACKEND_URL \|\| 'https:\/\/tracexdata-api\.onrender\.com';/g, "");
